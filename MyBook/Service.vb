...
Namespace Services
    ...
    Public MustInherit Class Service(Of Tkey, TEntity As MyBook.IHasPrimaryKey(Of Tkey), TRepository As Repositories.IRepository(Of Tkey, TEntity))
        ...
        MustOverride Function ToModel(Entity As TEntity) As TEntity
