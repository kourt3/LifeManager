Imports BuildAndApartmentCompoent.BuildAndApartment.Build.Entity

Namespace BuildAndApartment.Build.Contracts
    Public Interface IReference
        Inherits MyBook.IHasPrimaryKey(Of Integer)
    End Interface
    Public Interface IModel
        Inherits IReference
        Inherits MyBook.ISquareMeters, MyBook.IHasDescription, Entity.IAddresess
    End Interface
