Namespace BuildAndApartment.Apartment.Service
    Public Class Service
        Inherits MyBook.Services.Service(Of Integer, Contracts.Contracts, Apartment.Entity.Entity, Repository.Repository)
        ...
        Public Overrides Function ToModel(Entity As Apartment.Entity.Entity) As Contracts.Contracts
        ...
        Public Overrides Function ToEntity(Of DTO)(DTOLink As DTO) As Apartment.Entity.Entity
            Dim Entity As New Apartment.Entity.Entity
        ...
        Public Overrides Function ToEntity(Of DTO)(DTOLink As DTO, Entity As Apartment.Entity.Entity) As Apartment.Entity.Entity
            If GetType(DTO) Is GetType(Contracts.IRegisterDTO) Then
                Dim DTOs As Contracts.IRegisterDTO = DTOLink
                With Entity
                    .BuildID = DTOs.BuildID
