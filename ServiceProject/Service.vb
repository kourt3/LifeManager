...
Public Interface IService(Of TKey, TModel As MyBook.IHasPrimaryKey(Of TKey), TEntity As MyBook.IHasPrimaryKey(Of TKey))
    ...
    Property Repository As MyBook.Repositories.IRepository(Of TKey, TEntity)
...
Public MustInherit Class Service(Of TKey, TModel As MyBook.IHasPrimaryKey(Of TKey), TEntity As MyBook.IHasPrimaryKey(Of TKey))
    Implements IService(Of TKey, TModel, TEntity)

    Public Property Repository As IRepository(Of TKey, TEntity) Implements IService(Of TKey, TModel, TEntity).Repository
    ...
    Overridable Function Exist(Ref As TModel) As MyBook.ValMsg(Of TModel) Implements IService(Of TKey, TModel, TEntity).Exist
        ...
        For Each Entity In Repository.Read_All
            If Equals(Entity.PrimaryKey, Ref.PrimaryKey) Then
