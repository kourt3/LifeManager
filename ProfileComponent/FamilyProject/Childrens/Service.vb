Namespace FamilyProject.Children.Service
    Public Class ChildrenService
        Inherits MyBook.Services.Service(Of Integer, FamilyProject.Children.Conctracts.Contracts, FamilyProject.Children.Entity.Entity, Children.Repository.Repository)
